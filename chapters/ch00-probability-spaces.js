...
window.CHAPTERS.push({
    ...
    sections: [
        // ===== Section 1: σ-Algebras & Probability Measures =====
        {
            ...
            content: `
 <h2>σ-Algebras & Probability Measures</h2>

                <div class="env-block intuition">
                    <div class="env-title">Intuition</div>
                    <div class="env-body">
 <p>The foundation of probability theory rests on answering this question: to which "events" can we assign probabilities? Not all subsets can be assigned probabilities consistently (as shown by the Vitali construction), so we need a <strong>σ-algebra</strong> to precisely delineate the scope of "measurable events." Kolmogorov established the axiomatic framework of probability theory in 1933, grounding probability in measure theory.</p>
                    </div>
                </div>
                ...
                <div class="env-block definition">
                    ...
                    <div class="env-body">
 <p>Let \\(\\Omega\\) be a nonempty set. A <strong>σ-algebra</strong> on \\(\\Omega\\) is a collection \\(\\mathcal{F} \\subseteq 2^{\\Omega}\\) satisfying:</p>
                        <ol>
 ...
 <p>We call \\((\\Omega, \\mathcal{F})\\) a <strong>measurable space</strong>.</p>
                    </div>
                </div>
                ...
                <div class="env-block remark">
                    ...
                    <div class="env-body">
 <p>By De Morgan's laws, a σ-algebra is also closed under countable intersections. The smallest σ-algebra is \\(\\{\\emptyset, \\Omega\\}\\), and the largest is \\(2^{\\Omega}\\) (the power set of all subsets). On \\(\\mathbb{R}\\), the most commonly used is the <strong>Borel σ-algebra</strong> \\(\\mathcal{B}(\\mathbb{R})\\), generated by all open sets.</p>
                    </div>
                </div>
                ...
                <div class="env-block definition">
                    ...
                    <div class="env-body">
 <p>Let \\((\\Omega, \\mathcal{F})\\) be a measurable space. A mapping \\(P: \\mathcal{F} \\to [0,1]\\) is called a <strong>probability measure</strong> on \\(\\mathcal{F}\\) if:</p>
                        <ol>
 ...
 <p>The triple \\((\\Omega, \\mathcal{F}, P)\\) is called a <strong>probability space</strong>.</p>
                    </div>
                </div>
 ...
 <p>The interactive visualization below illustrates the intuitive meaning of the inclusion-exclusion principle on a Venn diagram. Drag the sliders to adjust \\(P(A)\\) and \\(P(B)\\) and observe how \\(P(A \\cup B)\\) changes.</p>
 ...
 title:'Interactive: Inclusion-Exclusion Venn Diagram',
        ...
        // ===== Section 2: Conditional Probability & Independence =====
        {
            ...
            content: `
 <h2>Conditional Probability & Independence</h2>

                <div class="env-block intuition">
                    <div class="env-title">Intuition</div>
                    <div class="env-body">
 <p>The core idea of <strong>conditional probability</strong> is "updating information": once we learn that event \\(B\\) has occurred, how should our belief about event \\(A\\) be adjusted? From the frequentist perspective, we "shrink" the sample space to \\(B\\), focusing only on the proportion of times \\(A\\) also occurs when \\(B\\) occurs. <strong>Bayes' theorem</strong> then provides the method for inverse reasoning — computing the probability of a "cause" from an observed "effect."</p>
                    </div>
                </div>
                ...
                <div class="env-block definition">
                    ...
                    <div class="env-body">
 <p>Let \\((\\Omega, \\mathcal{F}, P)\\) be a probability space, \\(B \\in \\mathcal{F}\\) with \\(P(B)> 0\\). The <strong>conditional probability</strong> of event \\(A \\in \\mathcal{F}\\) given \\(B\\) is defined as:</p>
 ...
 <p>Here \\(P(B_j)\\) is the <strong>prior probability</strong>, \\(P(B_j \\mid A)\\) is the <strong>posterior probability</strong>, and \\(P(A \\mid B_j)\\) is the <strong>likelihood</strong>.</p>
                    </div>
                </div>
 ...
 <p>Even though the test appears "very accurate," because the prior probability is extremely low, the positive predictive value (PPV) is only about 1.94%. This is the classic manifestation of the <strong>base rate fallacy</strong>.</p>
                    </div>
                </div>
                ...
                <div class="env-block definition">
                    ...
                    <div class="env-body">
 <p>Events \\(A\\) and \\(B\\) are <strong>independent</strong> if \\(P(A \\cap B) = P(A) \\cdot P(B)\\).</p>
 <p>A family of events \\(\\{A_i\\}_{i \\in I}\\) is <strong>mutually independent</strong> if for any finite subset \\(J \\subseteq I\\):</p>
 ...
 title:'Interactive: Bayesian Disease Testing',
 ...
 VizEngine.createSlider(controls,'Prevalence', 0.001, 0.3, prevalence, 0.001, function(v) {
                            prevalence = v; draw();
                        });
 VizEngine.createSlider(controls,'Sensitivity', 0.5, 1.0, sensitivity, 0.01, function(v) {
                            sensitivity = v; draw();
                        });
 VizEngine.createSlider(controls,'Specificity', 0.5, 1.0, specificity, 0.01, function(v) {
                            specificity = v; draw();
                        });
        ...
        // ===== Section 3: Random Variables & Distribution Functions =====
        {
            ...
            content: `
 <h2>Random Variables & Distribution Functions</h2>

                <div class="env-block intuition">
                    <div class="env-title">Intuition</div>
                    <div class="env-body">
 <p>In practice, we often care not about the abstract sample point \\(\\omega\\), but about numerical information extracted from an experiment — such as "the number shown on a die roll" or "the thermometer reading." A <strong>random variable</strong> is the bridge that maps the abstract probability space to the real line. It must be a <strong>measurable function</strong>, ensuring that events like"\\(X \\leq x\\)" belong to the σ-algebra and can therefore be assigned probabilities.</p>
                    </div>
                </div>
                ...
                <div class="env-block definition">
                    ...
                    <div class="env-body">
 <p>Let \\((\\Omega, \\mathcal{F}, P)\\) be a probability space. A mapping \\(X: \\Omega \\to \\mathbb{R}\\) is called a (real-valued) <strong>random variable</strong> if for every \\(x \\in \\mathbb{R}\\):</p>
                ...
                <div class="env-block definition">
                    ...
                    <div class="env-body">
 <p>The <strong>cumulative distribution function</strong> (CDF) of a random variable \\(X\\) is \\(F_X: \\mathbb{R} \\to [0,1]\\):</p>
                        \\[F_X(x) = P(X \\leq x).\\]
                    </div>
                </div>
                ...
                <div class="env-block definition">
                    ...
                    <div class="env-body">
 <p><strong>Discrete case:</strong> If \\(X\\) takes values in a countable set \\(\\{x_1, x_2, \\ldots\\}\\), its <strong>probability mass function</strong> (PMF) is \\(p_X(x_k) = P(X = x_k)\\), with \\(\\sum_k p_X(x_k) = 1\\). In this case the CDF is a step function.</p>
 <p><strong>Continuous case:</strong> If there exists a non-negative integrable function \\(f_X\\) such that \\(F_X(x) = \\int_{-\\infty}^{x} f_X(t) \\, dt\\), then \\(f_X\\) is called the <strong>probability density function</strong> (PDF) of \\(X\\). At points where \\(F\\) is differentiable, \\(f_X(x) = F_X'(x)\\).</p>
                    </div>
                </div>
            ...
            visualizations: [
                {
                    id: 'cdf-builder-viz',
 title:'Interactive: CDF Comparison — Discrete vs Continuous',
        ...
        // ===== Section 4: Expectation, Variance & Moments =====
        {
            ...
            content: `
 <h2>Expectation, Variance & Moments</h2>

                <div class="env-block intuition">
                    <div class="env-title">Intuition</div>
                    <div class="env-body">
 <p>The <strong>expected value</strong> can be understood as the "center of mass": if at each point \\(x\\) on the number line we place mass \\(P(X = x)\\) (discrete) or mass density \\(f(x)\\) (continuous), then \\(\\mathbb{E}[X]\\) is the fulcrum position that exactly balances this "lever." The <strong>variance</strong> \\(\\operatorname{Var}(X)\\) measures the dispersion of mass around the center — analogous to the moment of inertia in physics.</p>
                    </div>
                </div>
 ...
 <p>The <strong>standard deviation</strong> is \\(\\operatorname{SD}(X) = \\sqrt{\\operatorname{Var}(X)}\\).</p>
                    </div>
                </div>
                ...
                <div class="env-block definition">
                    ...
                    <div class="env-body">
 <p>The \\(k\\)-th <strong>moment</strong> of a random variable \\(X\\) is \\(\\mu_k' = \\mathbb{E}[X^k]\\) (if it exists).</p>
 <p>The \\(k\\)-th <strong>central moment</strong> is \\(\\mu_k = \\mathbb{E}[(X - \\mathbb{E}[X])^k]\\).</p>
 <p>In particular: \\(\\mu_1' = \\mathbb{E}[X]\\) (mean), \\(\\mu_2 = \\operatorname{Var}(X)\\). The <strong>skewness</strong> and <strong>kurtosis</strong> are \\(\\gamma_1 = \\mu_3 / \\mu_2^{3/2}\\) and \\(\\kappa = \\mu_4 / \\mu_2^2 - 3\\) (excess kurtosis), respectively.</p>
                    </div>
                </div>
 ...
 title:'Interactive: The "Balance Point" of Expectation',
        ...
        // ===== Section 5: Moment Generating Functions & Characteristic Functions =====
        {
            ...
            content: `
 <h2>Moment Generating Functions & Characteristic Functions</h2>

                <div class="env-block intuition">
                    <div class="env-title">Intuition</div>
                    <div class="env-body">
 <p>The <strong>moment generating function</strong> (MGF) and the <strong>characteristic function</strong> (CF) are both tools that "encode" all the information about a random variable into a single function — similar to how the Fourier transform encodes a signal. The advantage of the MGF is that moments can be "extracted" simply by differentiation; the advantage of the characteristic function is that it always exists (unlike the MGF) and uniquely determines the distribution. These two tools are indispensable for proving core results such as the central limit theorem.</p>
                    </div>
                </div>
                ...
                <div class="env-block definition">
                    ...
                    <div class="env-body">
 <p>The <strong>moment generating function</strong> (MGF) of a random variable \\(X\\) is:</p>
 ...
 title:'Interactive: MGF & Moment Extraction',
