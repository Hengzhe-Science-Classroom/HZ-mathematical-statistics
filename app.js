...
const App = {
    ...
    // --- Progress ---
    loadProgress() {
        try { this.progress = JSON.parse(localStorage.getItem('mathematical-statistics-progress') || '{}'); }
        catch (e) { this.progress = {}; }
    },
    saveProgress() {
        try { localStorage.setItem('mathematical-statistics-progress', JSON.stringify(this.progress)); } catch (e) {}
    },
